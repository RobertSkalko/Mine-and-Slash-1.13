...
public class RenderRegister {
    ...
    public static void regRenders(FMLClientSetupEvent evt) {
        ...
        RenderingRegistry.registerEntityRenderingHandler(SpellIceBomb.EntityIceBomb.class, IceBombRenderer::new);
