...
public class StatConfig {
	...
	mana_per_level = builder.translation("mmorpg.stat.mana_per_level").define("mana_per_level", 0F);
	physical_damage = builder.translation("mmorpg.stat.energy").define("energy", 100F);
	physical_damage = builder.translation("mmorpg.stat.energy_per_level").define("energy_per_level", 0F);
	physical_damage = builder.translation("mmorpg.stat.mana_regen").define("mana_regen", 3F);
	physical_damage = builder.translation("mmorpg.stat.mana_regen_per_level").define("mana_regen_per_level", 0F);

	physical_damage = builder.translation("mmorpg.stat.health_regen").define("health_regen", 5F);
	physical_damage = builder.translation("mmorpg.stat.health_regen_per_level").define("health_regen_per_level",
		1F);
	physical_damage = builder.translation("mmorpg.stat.armor").define("armor", 10F);
	physical_damage = builder.translation("mmorpg.stat.armor_per_level").define("armor_per_level", 5F);
	physical_damage = builder.translation("mmorpg.stat.health").define("health", 100F);
	physical_damage = builder.translation("mmorpg.stat.health_per_level").define("health_per_level", 10F);
	physical_damage = builder.translation("mmorpg.stat.critical_hit").define("critical_hit", 1F);
	physical_damage = builder.translation("mmorpg.stat.critical_hit_per_level").define("critical_hit_per_level",
		0F);
	physical_damage = builder.translation("mmorpg.stat.energy_regen").define("energy_regen", 5F);
	physical_damage = builder.translation("mmorpg.stat.energy_regen_per_level").define("energy_regen_per_level",
		0F);
	physical_damage = builder.translation("mmorpg.stat.critical_damage").define("critical_damage", 0F);
