...
public class OnDisplayDamage {
	...
	// mc.particles.addParticle(particleData, x, y, z, xSpeed, ySpeed, zSpeed)
	// Minecraft.getInstance().world(damageIndicator, false, data.x, data.y +
	// data.y, data.z, 1D, 1D, 1D); // UNSURE
	// IF
	// WORKS
	// COULD
	// ERROR
