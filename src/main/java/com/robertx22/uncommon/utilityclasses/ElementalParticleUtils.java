...
public class ElementalParticleUtils {
    ...
    public static void SpawnAoeParticle(Elements element, World world, BlockPos pos,
                                        double radius, int amount) {

        String name = new AoeProjectileParticleGen().Name();

        ParticleUtils.spawnParticleGenerator(world, pos, name, pos.getX(), pos.getY(), pos
                .getZ(), 1, 1, 1, radius, amount, element);
    }
