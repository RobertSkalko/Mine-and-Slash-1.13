...
public class ContainerInventoryRepair extends Container {
	...
	for (int x = 0; x < FUEL_SLOTS_COUNT; x++) {
	    ...
	    addSlot(new SlotFuel(tileInventoryFurnace, slotNumber, FUEL_SLOTS_XPOS + SLOT_X_SPACING * x,
		    FUEL_SLOTS_YPOS));
	}
	...
	for (int y = 0; y < INPUT_SLOTS_COUNT; y++) {
	    ...
	    addSlot(new SlotSmeltableInput(tileInventoryFurnace, slotNumber, INPUT_SLOTS_XPOS,
	...
	for (int y = 0; y < OUTPUT_SLOTS_COUNT; y++) {
	    ...
	    addSlot(new SlotOutput(tileInventoryFurnace, slotNumber, OUTPUT_SLOTS_XPOS,
	...
	for (int x = 0; x < 1; x++) {
	    ...
	    addSlot(new Slot(tileInventoryFurnace, slotNumber, CAPACITOR_SLOTS_XPOS + SLOT_X_SPACING * x,
