...
import com.robertx22.world_gen.features.teststruc;
...
public class WorldGenRegisters {
    ...
    public static final CompositeFeature test = Biome.createCompositeFeature(new teststruc(), IFeatureConfig.NO_FEATURE_CONFIG, Biome.AT_SURFACE_WITH_CHANCE, new ChanceConfig(20));

    public static void register() {

        for (Biome biome : Biome.BIOMES) {
            biome.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, randomSurfaceChest);
            biome.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, test);
