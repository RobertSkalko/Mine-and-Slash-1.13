 ...
 */
public class ContainerGearRepair extends Container {
    ...
    public static final ContainerType<ContainerGearRepair> TYPE = new ContainerType<>(ContainerGearRepair::new);

    private ContainerGearRepair(int i, PlayerInventory playerInventory) {
        super(TYPE, i);
    }

    public ContainerGearRepair(int num, PlayerInventory invPlayer,
    ...
    public ItemStack transferStackInSlot(PlayerEntity player, int sourceSlotIndex) {
        ...
        if (sourceSlotIndex >= VANILLA_FIRST_SLOT_INDEX && sourceSlotIndex < VANILLA_FIRST_SLOT_INDEX + VANILLA_SLOT_COUNT) {
            ...
            if (!new TileInventoryRepair().getSmeltingResultForItem(sourceStack)
                    .isEmpty()) { // isEmptyItem
