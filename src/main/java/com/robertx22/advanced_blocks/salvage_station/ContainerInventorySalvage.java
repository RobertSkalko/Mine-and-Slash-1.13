...
public class ContainerInventorySalvage extends Container {
	...
	for (int y = 0; y < INPUT_SLOTS_COUNT; y++) {
	    ...
	    addSlot(new SlotSmeltableInput(tileInventorySalvage, slotNumber, INPUT_SLOTS_XPOS,
	...
	for (int y = 0; y < OUTPUT_SLOTS_COUNT; y++) {
	    ...
	    addSlot(new SlotOutput(tileInventorySalvage, slotNumber, OUTPUT_SLOTS_XPOS,
	...
	for (int x = 0; x < 1; x++) {
	    ...
	    addSlot(new Slot(tileInventorySalvage, slotNumber, CAPACITOR_SLOTS_XPOS + SLOT_X_SPACING * x,
